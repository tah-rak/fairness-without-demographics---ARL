...
from data_utils.compas_input import CompasInput  # Ensure this is imported for the test.  
...
class FairnessMetricsTest(tf.test.TestCase, absltest.TestCase):
  ...
  def setUp(self):
    ...
    self.label_column_name = 'manner_of_death'  # For the compas dataset, this is the target variable.
